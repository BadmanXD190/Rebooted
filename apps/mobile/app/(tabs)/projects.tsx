...
export default function ProjectsScreen() {
  ...
  async function loadProjects() {
    ...
    // Sort by due date: projects with due dates first (ascending), then projects without due dates
    const sortedProjects = activeProjects.sort((a, b) => {
      // If both have due dates, sort by date (earliest first)
      if (a.due_date && b.due_date) {
        return new Date(a.due_date).getTime() - new Date(b.due_date).getTime();
      }
      // Projects with due dates come before projects without
  ...
  function handleViewCompleted() {
    ...
    router.push('/(tabs)/completed-projects');
  }
